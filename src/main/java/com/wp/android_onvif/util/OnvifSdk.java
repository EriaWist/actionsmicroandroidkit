...
public class OnvifSdk {
    ...
    public synchronized static void findDevice(Context context){
        ...
        findDevice(context, broadcastIP, new FindDevicesThread.FindDevicesListener() {
            @Override
...
//            creatDevice(ipAdress, user, pd);
    ...
    /**
     *
     * 修改摄像头Ip,修改之前最好最ip验证，保证新的ip地址为239.255.255.250这个网段下，否者回到值修改后找不到该设备。
   ...
   /**
     ...
     *
     * @param context  context
     * @param ipAdress 239.255.255.250
