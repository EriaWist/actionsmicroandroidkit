...
public class AndroidAacEldDecoder implements IAacEldDecoder {
	...
	public void init() {
		try {
			MediaCodec mediaCodec = null;//MediaCodec.createDecoderByType("audio/mp4a-latm");
			mediaCodec = MediaCodec.createByCodecName("OMX.google.aac.decoder");
