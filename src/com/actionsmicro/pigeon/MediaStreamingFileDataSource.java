...
public class MediaStreamingFileDataSource extends MediaStreamingFileBaseDataSource {
	...
	private static final List<String> SUPPORTED_VIDEO_FILE_EXTENSIONS = Arrays.asList("avi", "divx", "xvid", "mp4", "mov", "vob", "dat", "ts", "m2ts", "mts", "mkv", "rmvb", "rm", "mpg", "mpeg", "wmv", "m4v", "3gp"); //"aac", "wav", "ogg", "asf", "flv"
	private static final List<String> SUPPORTED_AUDIO_FILE_EXTENSIONS = Arrays.asList("ape", "flac", "ogg", "mp3", "wma", "wav", "rm", "m4a", "aac");
